...
import logoBianco from "../assets/colfert_bianco.png";
import jsPDF from "jspdf";
import PopupProfilo from "./profilo-popup";
import AddPermissionPopup from "./add-permission-popup";
// RIMOZIONE: Se il file è in 'public', non deve essere importato.
// import manualeWebStatistics from "../assets/manuale-web-statistics.pdf"; 
...
    // MODIFICA: Utilizza il percorso statico '/' per accedere al file nella cartella 'public'
    const downloadPDF = () => {
        // La variabile manualeWebStatistics non esiste più; usiamo il percorso statico
        const staticPath = "/manuale-web-statistics.pdf"; 

        const link = document.createElement('a');
        // Usa il percorso statico
        link.href = staticPath; 
        link.download = "manuale-web-statistics.pdf"; 
